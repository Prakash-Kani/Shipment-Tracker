...
def build_shipment_status_message(job_number: str, truck_number: str) -> Optional[str]:
    ...
    if truck_data[0]["truck_tracking_status_name"] in STATUS_FUNCTIONS:
    ...
    elif truck_data[0]["truck_tracking_status_name"] in STATUS_FUNCTIONS:
        truck_data = truck_data[0]

        status_data = get_status(truck_data["truck_tracking_status_name"].value.lower())
